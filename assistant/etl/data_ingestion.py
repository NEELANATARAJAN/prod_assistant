...
class DataIngestion:
    ...
    def __init__(self):
        """ Initialize the environment variables, embedding model and set CSV file path."""
    ...
    def _get_csv_path(self):
        ...
        if not os.path.exists(csv_path):
            raise FileNotFoundError(f"CSV File not found in the path {csv_path}")
        return csv_path
    ...
    def _load_csv(self):
        ...
        print(f"[_load_csv] column names: {df.columns}")
    ...
    def store_in_vectordb(self, documents: List[Document]):
        """ Store documents in AstraDB vector store."""
